...
public class DomainEventHandlerLast implements EventHandler<EventDisruptor>, LifecycleAware {

	private DisruptorFactory disruptorFactory;

	public DomainEventHandlerLast(DisruptorFactory disruptorFactory) {
		super();
	...
	public void onEvent(EventDisruptor event, long arg1, boolean arg2) throws Exception {
		// Object owner = event.getDomainMessage().getOwner();
		// disruptorFactory.releaseDisruptor(owner);
