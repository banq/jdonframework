...
public class DomainCommandHandlerLast implements EventHandler<EventDisruptor>, LifecycleAware {

	private DisruptorForCommandFactory disruptorForCommandFactory;

	public DomainCommandHandlerLast(DisruptorForCommandFactory disruptorForCommandFactory) {
		super();
	...
	public void onEvent(EventDisruptor event, long arg1, boolean arg2) throws Exception {
		// disruptorForCommandFactory.releaseDisruptor(owner);
