...
public class JdonDisruptor<T> {
	 ...
	 */
	public JdonDisruptor(final EventFactory<T> eventFactory, final int ringBufferSize, final Executor executor) {
	 ...
	 */
	public JdonDisruptor(final EventFactory<T> eventFactory, final Executor executor, final ClaimStrategy claimStrategy,
			final WaitStrategy waitStrategy) {
		this(new RingBuffer<T>(eventFactory, claimStrategy, waitStrategy), executor);
	}

	private JdonDisruptor(final RingBuffer<T> ringBuffer, final Executor executor) {
