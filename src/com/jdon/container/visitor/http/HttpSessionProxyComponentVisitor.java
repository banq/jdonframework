 ...
 * Proxy patterns. 
 * 
 * created in {@link HttpSessionVisitorFactoryImp#createtVisitor(com.jdon.controller.context.SessionWrapper, com.jdon.bussinessproxy.TargetMetaDef)}
 * used in {@link UserTargetMetaDefFactory#createTargetMetaRequest(com.jdon.bussinessproxy.TargetMetaDef, com.jdon.controller.context.ContextHolder)}
 * ComponentVisitor is ComponentOriginalVisitor that configured in contain.xml
 * 
 * @see HttpSessionVisitorFactoryImp
 * @author banq
 */
public class HttpSessionProxyComponentVisitor implements  ComponentVisitor, HttpSessionBindingListener {
    /**
	 * 
	 */
